...
function getGreeting(name) {
    ...
    //return greeting;
	//http://qaru.site/questions/475/how-do-you-check-for-an-empty-string-in-javascript
    
    if (!name || typeof name !== 'undefined' || /^\s, \0*$/.test(name)) {  /* Здесь: typeof name если переменная не была указа или имеет значение undefined
	^- поиск с начала строки \s- совпадение с любым  пробельным символом
	\0- совпадение с null *- любое количество раз $- до конца строки   */
	name = 'Аноним';
    }
